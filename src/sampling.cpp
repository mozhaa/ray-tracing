...
sampler::sampler(glm::vec3 normal, std::minstd_rand0 &rng) : normal(normal), rng(rng) {}
...
true_uniform_sampler::true_uniform_sampler(glm::vec3 normal, std::minstd_rand0 &rng) : sampler(normal, rng) {}

std::pair<glm::vec3, float> true_uniform_sampler::sample() const {
...
uniform_sampler::uniform_sampler(glm::vec3 normal, std::minstd_rand0 &rng) : sampler(normal, rng) {}

std::pair<glm::vec3, float> uniform_sampler::sample() const {
...
cosine_sampler::cosine_sampler(glm::vec3 normal, std::minstd_rand0 &rng) : sampler(normal, rng) {}

std::pair<glm::vec3, float> cosine_sampler::sample() const {
    std::uniform_real_distribution<float> d(0.f, 1.f);
    float e1 = d(rng), e2 = d(rng);
...
power_cosine_sampler::power_cosine_sampler(glm::vec3 normal, std::minstd_rand0 &rng, float alpha) : sampler(normal, rng), alpha(alpha) {}

std::pair<glm::vec3, float> power_cosine_sampler::sample() const {
    std::uniform_real_distribution<float> d(0.f, 1.f);
    float e1 = d(rng), e2 = d(rng);
